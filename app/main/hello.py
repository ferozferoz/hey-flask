...
def followed(username):
    ...
    return render_template('followed.html', user=user, title="follows",endpoint='.followed', pagination=pagination, followed=followed)

@main.route('/post/<int:id>')
def post(id):
    post=Post.query.get_or_404(id)
    return render_template('post1.html',posts=[post])
